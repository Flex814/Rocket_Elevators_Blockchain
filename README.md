# Originally from HashLips 👄

![](https://github.com/HashLips/hashlips_nft_minting_dapp/blob/main/logo.png)

## Website

You can find the link to the uploaded Dapp here: https://rocket-elevators-dapp.herokuapp.com
...
In order to test this dapp, just run the following command:

```
npm run test
```

After the tests have passed, you can locally run the Dapp using the following command:
